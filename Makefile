#############################################################################
# Makefile for building: hello.app/Contents/MacOS/hello
...
CFLAGS        = -pipe -O2 $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -fPIC -Wall -Wextra $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -fPIC -Wall -Wextra $(DEFINES)
...
COMPRESS      = gzip -9f
DISTNAME      = hello1.0.0
DISTDIR = /Users/marcusbernroth/Tutorials/qt/hello/.tmp/hello1.0.0
LINK          = /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++
LFLAGS        = -stdlib=libc++ -headerpad_max_install_names $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -Wl,-rpath,@executable_path/../Frameworks -Wl,-rpath,/usr/local/lib
...
DIST          = /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		...
		hello.pro hello.h hello.cpp \
		main.cpp
QMAKE_TARGET  = hello
DESTDIR       = 
TARGET        = hello.app/Contents/MacOS/hello

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 12.3
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/marcusbernroth/Tutorials/qt/hello/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/marcusbernroth/Tutorials/qt/hello/hello.pro
...
hello.app/Contents/MacOS/hello:  $(OBJECTS)  
	@test -d hello.app/Contents/MacOS/ || mkdir -p hello.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: hello.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.4.0/share/qt/mkspecs/common/macx.conf \
...
hello.app/Contents/PkgInfo: 
	@test -d hello.app/Contents || mkdir -p hello.app/Contents
	@$(DEL_FILE) hello.app/Contents/PkgInfo
	@echo "APPL????" > hello.app/Contents/PkgInfo
hello.app/Contents/Resources/empty.lproj: 
	@test -d hello.app/Contents/Resources || mkdir -p hello.app/Contents/Resources
	@touch hello.app/Contents/Resources/empty.lproj
	
hello.app/Contents/Info.plist: 
	@test -d hello.app/Contents || mkdir -p hello.app/Contents
	@$(DEL_FILE) hello.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.hello,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.hello,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,hello,g" -e "s,@LIBRARY@,hello,g" -e "s,\$${EXECUTABLE_NAME},hello,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app >hello.app/Contents/Info.plist

all: Makefile \
		hello.app/Contents/PkgInfo \
		hello.app/Contents/Resources/empty.lproj \
		hello.app/Contents/Info.plist hello.app/Contents/MacOS/hello
...
distdir: FORCE
	...
	$(COPY_FILE) --parents hello.h $(DISTDIR)/
	$(COPY_FILE) --parents hello.cpp main.cpp $(DISTDIR)/
...
moc_predefs.h: /usr/local/share/qt/mkspecs/features/data/dummy.cpp
	/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.3.sdk -mmacosx-version-min=12.0 -fPIC -dM -E -o moc_predefs.h /usr/local/share/qt/mkspecs/features/data/dummy.cpp
...
main.o: main.cpp /usr/local/lib/QtCore.framework/Headers/QCoreApplication \
